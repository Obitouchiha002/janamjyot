...
const STRINGS: Record<string, { hi: string; hinglish: string }> = {
  ...
  "Sun": { hi: "सूर्य", hinglish: "Surya" },
  // Short on purpose: "Talk to Astrologer" wrapped onto two lines inside a pill.
  "Ask": { hi: "बात करें", hinglish: "Baat karein" },
  ...
  "Positive": { hi: "अच्छी बातें", hinglish: "Achhi baatein" },
  "Cautions": { hi: "सावधानियाँ", hinglish: "Savdhaniyan" },
  "Practical Guidance": { hi: "व्यावहारिक सलाह", hinglish: "Kaam ki salah" },
  "Wealth": { hi: "धन", hinglish: "Dhan" },
  "Marriage": { hi: "विवाह", hinglish: "Shaadi" },
  "Relationships": { hi: "रिश्ते", hinglish: "Rishte" },
  "What should I do?": { hi: "मैं क्या करूँ?", hinglish: "Main kya karun?" },
  "Decide together": { hi: "साथ में तय करें", hinglish: "Saath mein tay karein" },
  "Past decisions": { hi: "पिछले फ़ैसले", hinglish: "Pichhle faisle" },
  "Write it the way you would say it to a friend. One line is enough.": {
    hi: "जैसे किसी दोस्त से कहते, वैसे ही लिखिए। एक लाइन काफ़ी है।",
    hinglish: "Jaise kisi dost se kehte, waise hi likhiye. Ek line kaafi hai.",
  },
  "e.g. Usse 3 din se baat nahi hui — message karun ya nahi?": {
    hi: "जैसे: उससे 3 दिन से बात नहीं हुई — मैसेज करूँ या नहीं?",
    hinglish: "Jaise: usse 3 din se baat nahi hui — message karun ya nahi?",
  },
  "Help me decide": { hi: "तय करने में मदद करें", hinglish: "Tay karne mein madad karein" },
  "Tell me what is going on": { hi: "बताइए क्या चल रहा है", hinglish: "Bataiye kya chal raha hai" },
  "Jaise kisi dost se kehte ho, waise hi likho ya bolo. Koi sawaal banane ki zaroorat nahi — jo chal raha hai wahi bata do.": {
    hi: "जैसे किसी दोस्त से कहते हैं, वैसे ही लिखिए या बोलिए। सवाल बनाने की ज़रूरत नहीं — जो चल रहा है वही बता दीजिए।",
    hinglish: "Jaise kisi dost se kehte ho, waise hi likho ya bolo. Koi sawaal banane ki zaroorat nahi — jo chal raha hai wahi bata do.",
  },
  "Usse 3 din se baat nahi hui": { hi: "उससे 3 दिन से बात नहीं हुई", hinglish: "Usse 3 din se baat nahi hui" },
  "Job offer aaya hai, samajh nahi aa raha": { hi: "जॉब ऑफर आया है, समझ नहीं आ रहा", hinglish: "Job offer aaya hai, samajh nahi aa raha" },
  "Aaj din bahut kharab tha": { hi: "आज दिन बहुत ख़राब था", hinglish: "Aaj din bahut kharab tha" },
  "Ab faisla batao": { hi: "अब फ़ैसला बताइए", hinglish: "Ab faisla batao" },
  "Jo chal raha hai, likho…": { hi: "जो चल रहा है, लिखिए…", hinglish: "Jo chal raha hai, likho…" },
  "Listening…": { hi: "सुन रहा हूँ…", hinglish: "Sun raha hoon…" },
  "Speak": { hi: "बोलिए", hinglish: "Bolein" },
  "Send": { hi: "भेजें", hinglish: "Bhejein" },
  "Guidance, not a guarantee. Nothing here is medical, legal or money advice.": {
    hi: "यह मार्गदर्शन है, गारंटी नहीं। यह चिकित्सा, क़ानूनी या पैसे की सलाह नहीं है।",
    hinglish: "Ye guidance hai, guarantee nahi. Ye medical, legal ya paise ki salah nahi hai.",
  },
  "Skip these and answer anyway": { hi: "इन्हें छोड़कर जवाब दें", hinglish: "Inhe chhodkar jawab dein" },
  "Yes": { hi: "हाँ", hinglish: "Haan" },
  "No": { hi: "नहीं", hinglish: "Nahi" },
  "Wait": { hi: "रुकिए", hinglish: "Ruko" },
  "Good time right now": { hi: "अभी अच्छा समय है", hinglish: "Abhi achha samay hai" },
  "Best window today": { hi: "आज का सबसे अच्छा समय", hinglish: "Aaj ka sabse achha samay" },
  "Best time today": { hi: "आज का सबसे अच्छा समय", hinglish: "Aaj ka sabse achha samay" },
  "Best time tomorrow": { hi: "कल का सबसे अच्छा समय", hinglish: "Kal ka sabse achha samay" },
  "Best window tomorrow": { hi: "कल का सबसे अच्छा समय", hinglish: "Kal ka sabse achha samay" },
  "Stay out of": { hi: "इससे बचें", hinglish: "Isse bachein" },
  "What to send": { hi: "क्या भेजें", hinglish: "Kya bhejein" },
  "Straight": { hi: "सीधा", hinglish: "Seedha" },
  "Gentler": { hi: "नरम", hinglish: "Halka" },
  "Copy": { hi: "कॉपी", hinglish: "Copy" },
  "Copied": { hi: "कॉपी हो गया", hinglish: "Copy ho gaya" },
  "If it goes the other way": { hi: "अगर उल्टा हुआ तो", hinglish: "Agar ulta hua to" },
  "Don't do this": { hi: "यह मत कीजिए", hinglish: "Ye mat kijiye" },
  "Later: what happened?": { hi: "बाद में: क्या हुआ?", hinglish: "Baad mein: kya hua?" },
  "It went well": { hi: "अच्छा रहा", hinglish: "Achha raha" },
  "No reply yet": { hi: "अभी जवाब नहीं आया", hinglish: "Abhi reply nahi aaya" },
  "It didn't go well": { hi: "अच्छा नहीं रहा", hinglish: "Achha nahi raha" },
  "I didn't do it": { hi: "मैंने किया ही नहीं", hinglish: "Maine kiya hi nahi" },
  "Saved — this makes your next decision sharper.": {
    hi: "सहेज लिया — इससे आपका अगला फ़ैसला बेहतर होगा।",
    hinglish: "Save ho gaya — isse aapka agla faisla behtar hoga.",
  },
  "Ask something else": { hi: "कुछ और पूछें", hinglish: "Kuch aur poochhein" },
  "Nothing here yet": { hi: "अभी कुछ नहीं है", hinglish: "Abhi kuch nahi hai" },
  "Every decision you work through is saved here.": {
    hi: "आप जो भी फ़ैसला यहाँ तय करते हैं, वह यहीं सहेजा जाता है।",
    hinglish: "Aap jo bhi faisla yahan tay karte hain, wo yahin save hota hai.",
  },
  "Went well": { hi: "अच्छा रहा", hinglish: "Achha raha" },
  "Didn't go well": { hi: "अच्छा नहीं रहा", hinglish: "Achha nahi raha" },
  "No reply": { hi: "जवाब नहीं आया", hinglish: "Reply nahi aaya" },
  "Didn't do it": { hi: "नहीं किया", hinglish: "Nahi kiya" },
  "Still waiting": { hi: "अभी इंतज़ार है", hinglish: "Abhi intezaar hai" },
